// src/components/EventCreationTutorial.jsx
import React from "react";
import { useTheme } from "@mui/material";
import { Stepper, Step, StepLabel, Typography, Box } from "@mui/material";

/**
 * Component that displays a step-by-step tutorial for creating an event.
 * Uses MUI Stepper for a clear and modern rendering.
 */
export default function EventCreationTutorial() {
  ...
  const steps = [
    {
      ...
      content:
        'Briefly explain the purpose of the event (up to 100 characters). For example: "Who will win match X?".',
    },
    {
      title: "Choose the Closing Date and Time",
      content:
        "Specify the date/time when event participation stops. It must be at least 1 hour in the future.",
    },
    {
